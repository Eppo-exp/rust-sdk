...
mod tests {
    ...
    fn test_precomputed_obfuscation() {
        ...
        assert_eq!(
            ...
            r#"{"variation_type":"STRING","variation_value":"aGVsbG8sIHdvcmxkIQ==","do_log":true,"allocation_key":"YWxsb2NhdGlvbi1rZXk=","variation_key":"dmFyaWF0aW9uLWtleQ==","extra_logging":{"aGVsbG8=":"d29ybGQ="}}"#
        );
    }
}
